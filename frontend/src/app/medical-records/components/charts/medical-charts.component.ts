...
export class MedicalChartsComponent implements OnChanges {
  ...
  private loadRiskEvolution(): void {
    this.http.get<any>(`/api/statistics/medical-record/${this.medicalRecordId}/risk-evolution`)
      .subscribe({
        next: (response) => {
  ...
  private loadActionsPerMonth(): void {
    this.http.get<any>(`/api/statistics/medical-record/${this.medicalRecordId}/actions-per-month`)
      .subscribe({
        next: (response) => {
          const data: ChartData = response.data;
  ...
  private loadRiskDistribution(): void {
    this.http.get<any>(`/api/statistics/medical-record/${this.medicalRecordId}/risk-factors-distribution`)
      .subscribe({
        next: (response) => {
          const data: ChartData = response.data;
