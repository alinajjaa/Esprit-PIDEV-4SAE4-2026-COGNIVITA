...
public class RendezVousService {
    ...
    public RendezVous createRendezVous(RendezVous rendezVous) {
        ...
        List<RendezVous> doctorCandidates =
                rendezVousRepository.findByMedecinIdAndDateHeureBetween(medecinId, from, to);
        ...
        // ---- Optional: Patient overlap
        List<RendezVous> patientCandidates =
                rendezVousRepository.findByPatientIdAndDateHeureBetween(patientId, from, to);
