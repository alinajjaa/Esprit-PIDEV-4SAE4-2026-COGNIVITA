...
class AppointmentServiceTest {
    ...
    @BeforeEach
    void setUp() {
        reminderJob = new AppointmentReminderJob(appointmentRepository, notificationService);
    }
    ...
    void autoMissJob_marksOverdueAsMissed() {
        ...
        when(appointmentRepository.findOverdueScheduled(any())).thenReturn(List.of(overdue));
    ...
    void autoMissJob_noOverdue_doesNothing() {
        when(appointmentRepository.findOverdueScheduled(any())).thenReturn(Collections.emptyList());
