...
public class Medication {
    ...
    /** Indicates whether this medication has known cognitive/dementia risk implications */
    @Column(name = "risk_flag", length = 50)
    private String riskFlag; // "PROTECTIVE", "RISK", "NEUTRAL"
